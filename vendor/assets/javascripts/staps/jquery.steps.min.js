...
//Change label depending on user that wil be added
//ang galing ni baby kasusumu hahahahah
function CheckUser(val){
	var x1 = document.getElementById("name1_label1");
	var x2 = document.getElementById("name1_label2");
	var x3 = document.getElementById("name1_label3");
	var y1 = document.getElementById("name2_label1");
	var y2 = document.getElementById("name2_label2");
	if(val=='student_org'){
